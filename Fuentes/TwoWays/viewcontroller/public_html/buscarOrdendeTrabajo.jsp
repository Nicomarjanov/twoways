...
<html>
  ...
  <thead>
  <tr>
    <th class="tw_form" colspan="100%" >Ingrese los criterios de busqueda para la orden </th>
  </tr>
  </thead>
  <tbody>
   <tr>
  ...
  <td  id="table-filtros" valign="top" align="left"  >  
   ...
   <table id ="tabla-busqueda" width="100%" >
    <thead>
      <tr><th nowrap >Nombre</th><th nowrap >Fecha de Inicio</th><th  nowrap >Fecha de Entrega</th><th nowrap >Cliente</th><th nowrap>Proyecto</th><th nowrap >Editar</th><th nowrap >Proyecto</th></tr> 
    </thead>
      <c:choose   >
