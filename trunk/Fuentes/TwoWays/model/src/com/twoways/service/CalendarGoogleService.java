...
public class CalendarGoogleService {
   ...
   */
   ...
   public   CalendarGoogleService(String userName){
   
    try {
      this.metafeedUrl = new URL(CalendarGoogleService.METAFEED_URL_BASE + userName);
      this.eventFeedUrl = new URL(CalendarGoogleService.METAFEED_URL_BASE + userName
          + CalendarGoogleService.EVENT_FEED_URL_SUFFIX);
  ...
  public  void printUserCalendars(CalendarService service)
    ...
    CalendarFeed resultFeed = service.getFeed(this.metafeedUrl, CalendarFeed.class);
  ...
  public  void printAllEvents(CalendarService service)
    ...
    // Send the request and receive the response:
    CalendarEventFeed resultFeed = service.getFeed(this.eventFeedUrl,
  ...
  public  void fullTextQuery(CalendarService service, String query)
      throws ServiceException, IOException {
    Query myQuery = new Query(this.eventFeedUrl);
  ...
  public  void dateRangeQuery(CalendarService service,
      ...
      IOException {
    CalendarQuery myQuery = new CalendarQuery(this.eventFeedUrl);
    ...
    public  void deleteDateRangeQuery(CalendarService service,
        DateTime startTime, DateTime endTime) throws ServiceException,
        IOException {
      CalendarQuery myQuery = new CalendarQuery(this.eventFeedUrl);
      myQuery.setMinimumStartTime(startTime);
      ...
      for (int i = 0; i < resultFeed.getEntries().size(); i++) {
        CalendarEventEntry entry = resultFeed.getEntries().get(i);
        System.out.println("\t" + entry.getTitle().getPlainText());
          eventsToDelete.add(entry);
      }
      deleteEvents(service, eventsToDelete);
      System.out.println();
    }
  ...
  public  CalendarEventEntry createEvent(CalendarService service,
      ...
      boolean isQuickAdd, WebContent wc, Calendar calendar ) throws ServiceException, IOException {
  ...
  public  CalendarEventEntry createSingleEvent(CalendarService service,
      String eventTitle, String eventContent, Calendar calendar) throws ServiceException,
      IOException {
    return createEvent(service, eventTitle, eventContent, null, false, null,calendar);
  }
  ...
  public  CalendarEventEntry createQuickAddEvent(
      CalendarService service, String quickAddContent,Calendar calendar) throws ServiceException,
      IOException {
    return createEvent(service, null, quickAddContent, null, true, null,calendar);
  }
  ...
  public  CalendarEventEntry createWebContentEvent(
      ...
      String icon, String width, String height,Calendar calendar) throws ServiceException,
      IOException {
    ...
    return createEvent(service, title, null, null, false, wc,calendar);
  }
  ...
  public  CalendarEventEntry createRecurringEvent(
      CalendarService service, String eventTitle, String eventContent,Calendar calendar)
      throws ServiceException, IOException {
   ...
   * @throws IOException Error communicating with the server.
   */
  public static CalendarEventEntry addReminder(CalendarEventEntry entry,
   ...
   * @throws IOException Error communicating with the server.
   */
  public static CalendarEventEntry addExtendedProperty(
  ...
  public static void usage() {
    ...
    public void setMetafeedUrl(URL metafeedUrl) {
        this.metafeedUrl = metafeedUrl;
    }

    public URL getMetafeedUrl() {
        return metafeedUrl;
    }

    public void setEventFeedUrl(URL eventFeedUrl) {
        this.eventFeedUrl = eventFeedUrl;
    }

    public URL getEventFeedUrl() {
        return eventFeedUrl;
    }
}
