...
function CalendarPopup() {
	...
	c.monthNames = new Array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubrer","Noviembre","Diciembre");
...
function CP_select(inputobj, linkname, format) {
	...
	if (this.displayType!="date"&&this.displayType!="week-end") {
        ...
        //alert(dwr.util.toDescriptiveString(inputobj,1));        
